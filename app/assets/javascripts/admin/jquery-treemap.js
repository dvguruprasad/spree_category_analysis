(function($) {
    ...
    TreeMap.prototype.paint = function(nodeList) {
        ...
        for (var i = 0; i < nodeList.length; i++) {
            ...
            var total_target_span = '<li>' +'<p class="left-label"> Target: </p><p class="right-label">' + node.total_target +' USD'+'</p></li>';
            var target_gap = '<li>' +'<p class="left-label"> Target Gap: </p><p class="right-label">' + Math.round((node.value - node.total_target)*100)/100 +' USD'+'</p></li>';
            ...
            var hoverDiv = '<div id="'+node.id+'hover"  class="tooltip" style="display:none"><ul class="tooltip-ul">' + sales_span +revenue_change_span +  total_target_span + target_gap + profit_span + profit_change_span +'</ul></div>';
