module Spree
    module Admin
        class PromotionCalculator 
            def self.compute_promotional_sales(sales_forecast, date_of_forecast, promotion_start_date, promotion_end_date, promotion_data,inventory_positions)
                promotion_percentage = compute_promotion_percentage(promotion_data)
