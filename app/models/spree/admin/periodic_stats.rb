    ...
    module Admin
        class PeriodicStats
            ...
            def self.generate(weekly_sales)
                ...
                revenue_variation = (target_revenue - total_revenue).round(2)
            ...
            def self.generate_with_promotion(weekly_sales, simulated_sales)
                ...
                promotional_profit_change = profit_change(simulated_sales, total_cost) - gross_profit
            ...
            def self.profit_change(simulated_sales, total_cost)
